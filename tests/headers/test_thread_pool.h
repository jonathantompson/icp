...
#include "icp/threading/thread.h"
#include "icp/threading/callback.h"
#include "icp/threading/thread_pool.h"
...
using icp::threading::ThreadPool;
using tests::CounterThreadSafe;
using icp::threading::Callback;
using icp::threading::MakeCallableOnce;
using icp::threading::MakeCallableMany;
